...
<div id="carouselExample" className="carousel slide">
  <div className="carousel-inner">
    <div className="carousel-item active">
      <Image src="/storage C.jpg" className="d-block w-100" alt="view" width={800} height={600}/>
    </div>
    <div className="carousel-item">
      <Image src="/dopge.jpg" className="d-block w-100" alt="view2" width={400} height={400}/>
    </div>
    <div className="carousel-item">
      <Image src="/gay1.jpg" className="d-block w-100" alt="view3" width={400} height={400}/>
    </div>
  </div>
